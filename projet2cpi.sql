...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 16 juil. 2019 à 23:24
...
CREATE TABLE IF NOT EXISTS `annonces` (
  ...
  `idColis_idTrajet` int(11) DEFAULT NULL,
...
INSERT INTO `annonces` (`idAnnonce`, `User_idUser`, `idColis_idTrajet`, `type`) VALUES
(1, 56, 7, NULL),
(2, 56, 54, NULL),
(3, 56, 57, NULL),
(4, 56, 53, NULL),
...
--
-- Structure de la table `avis_rating_envo`
--

DROP TABLE IF EXISTS `avis_rating_envo`;
CREATE TABLE IF NOT EXISTS `avis_rating_envo` (
...
--
-- Déchargement des données de la table `avis_rating_envo`
--

INSERT INTO `avis_rating_envo` (`idEnvoyeur`, `idTransporteur`, `avis`, `rating`, `dateAvis`) VALUES
(28, 11, 'il est bien', 5, '2019-07-05 21:58:25'),
(29, 17, 'un bon envoyeur', 5, '2019-07-05 22:05:18'),
(31, 12, 'bom envoyeur bom envoyeur bom envoyeur', 4, '2019-07-13 09:23:02');

-- --------------------------------------------------------

--
-- Structure de la table `avis_rating_trans`
--

DROP TABLE IF EXISTS `avis_rating_trans`;
CREATE TABLE IF NOT EXISTS `avis_rating_trans` (
...
--
-- Déchargement des données de la table `avis_rating_trans`
--

INSERT INTO `avis_rating_trans` (`id`, `idEnvoyeur`, `idTransporteur`, `avis`, `rating`, `dateAvis`) VALUES
(1, 28, 18, 'tres bon transpoteur', 5, '2019-07-16 08:08:45'),
(2, 31, 18, 'bon transporteur', 3, '2019-07-16 08:09:29');
...
CREATE TABLE IF NOT EXISTS `colis` (
  ...
  `DescriptionColis` longtext,
  `TailleColis` varchar(255) DEFAULT NULL,
  `PoidsColis` varchar(255) DEFAULT NULL,
  `Objet` varchar(45) DEFAULT NULL,
  `Envoyeur_idEnvoyeur` int(11) NOT NULL,
  `Valid` tinyint(1) DEFAULT NULL,
  `objetFrajile` tinyint(1) DEFAULT NULL,
  `demandeUrgente` tinyint(1) DEFAULT NULL,
  `demandeSpec` tinyint(1) DEFAULT NULL,
  `imagePath` varchar(255) DEFAULT NULL,
  `imageName` varchar(255) DEFAULT NULL,
  `Prix` varchar(15) DEFAULT NULL,
  PRIMARY KEY (`idColis`),
  UNIQUE KEY `idColis` (`idColis`),
  KEY `fk_Colis_Envoyeur1_idx` (`Envoyeur_idEnvoyeur`)
...
INSERT INTO `colis` (`idColis`, `DescriptionColis`, `TailleColis`, `PoidsColis`, `Objet`, `Envoyeur_idEnvoyeur`, `Valid`, `objetFrajile`, `demandeUrgente`, `demandeSpec`, `imagePath`, `imageName`, `Prix`) VALUES
(41, '', 'M', 'LÃ©ger', '', 36, 1, 0, 0, 0, '', '', '1985.831'),
(42, 'dxdfcgvhujkl', 'S', 'Lourd', 'TV', 36, 1, 0, 0, 0, '../uploads/5d2d7d16bc7d88.76358040.png', '5d2d7d16bc7d88.76358040.png', '714.831'),
(43, 'azertyuiop', 'M', 'LÃ©ger', 'TV', 36, 1, 0, 0, 0, '../uploads/5d2d80e50201f0.43289911.png', '5d2d80e50201f0.43289911.png', '2110.677'),
(44, 'ertyui', 'M', 'Lourd', 'TV', 36, 1, 0, 0, 0, '../uploads/5d2d82db0ee8c0.47976749.png', '5d2d82db0ee8c0.47976749.png', '2175.831');
...
--
-- Structure de la table `envoyeur`
--

DROP TABLE IF EXISTS `envoyeur`;
CREATE TABLE IF NOT EXISTS `envoyeur` (
  `idEnvoyeur` int(11) NOT NULL AUTO_INCREMENT,
  `Rating` double DEFAULT NULL,
  `User_idUser` int(11) NOT NULL,
  PRIMARY KEY (`idEnvoyeur`),
  UNIQUE KEY `idEnvoyeur_UNIQUE` (`idEnvoyeur`),
  KEY `fk_Envoyeur_User1_idx` (`User_idUser`)
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8;

--
-- Déchargement des données de la table `envoyeur`
--

INSERT INTO `envoyeur` (`idEnvoyeur`, `Rating`, `User_idUser`) VALUES
(28, 0, 62),
(29, 5, 63),
(31, 4, 65),
(36, 0, 64);
...
CREATE TABLE IF NOT EXISTS `invitations` (
  `idInvitations` int(11) NOT NULL AUTO_INCREMENT,
  `IdEnv` int(11) DEFAULT NULL,
  `User_idUser` int(11) NOT NULL,
  PRIMARY KEY (`idInvitations`),
  UNIQUE KEY `idInvitations_UNIQUE` (`idInvitations`),
  KEY `fk_Invitations_User1_idx` (`User_idUser`)
...
INSERT INTO `messages` (`id`, `idEnvoyeur`, `idRecepteur`, `msg`, `dateMsg`, `nouveau`) VALUES
(3, 64, 65, 'voici un test de message', '2019-07-15 15:31:46', 0),
(4, 63, 65, 'qu\'elle est votre adresse email?', '2019-07-15 15:31:46', 0),
(5, 65, 63, 'un message de test', '2019-07-15 16:18:05', 0);
...
CREATE TABLE IF NOT EXISTS `notification` (
  ...
  `notifType` varchar(20) CHARACTER SET utf8 DEFAULT NULL,
  `notif` varchar(150) CHARACTER SET utf8 DEFAULT NULL,
  `timeSent` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `isread` int(11) DEFAULT '0',
  `imgSource` varchar(55) CHARACTER SET utf8 DEFAULT NULL,
  PRIMARY KEY (`idNotif`)
...
INSERT INTO `notification` (`idNotif`, `userId`, `senderId`, `notifType`, `notif`, `timeSent`, `isread`, `imgSource`) VALUES
(1, 64, NULL, 'annd', 'votre annonce a ete depose avec succes', '2019-07-05 16:28:59', 1, NULL),
(2, 64, NULL, 'prem', 'votre status a ete mis a premium', '2019-07-05 16:40:42', 0, NULL),
(3, 64, NULL, 'cld', 'votre colis a ete depose avec succes', '2019-07-05 16:41:24', 0, NULL),
(4, 64, 65, 'invitation', 'vous a envoyer une invitation', '2019-07-11 23:39:36', 0, NULL);

-- --------------------------------------------------------

--
-- Structure de la table `relationenv_trans`
--

DROP TABLE IF EXISTS `relationenv_trans`;
CREATE TABLE IF NOT EXISTS `relationenv_trans` (
  `id_realtion` int(11) NOT NULL AUTO_INCREMENT,
  `idEnv` int(11) DEFAULT NULL,
  `idTrans` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_realtion`),
  UNIQUE KEY `id_realtion` (`id_realtion`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;

--
-- Déchargement des données de la table `relationenv_trans`
--

INSERT INTO `relationenv_trans` (`id_realtion`, `idEnv`, `idTrans`) VALUES
(1, 64, 62);

-- --------------------------------------------------------

--
-- Structure de la table `trajetcolis`
--

DROP TABLE IF EXISTS `trajetcolis`;
CREATE TABLE IF NOT EXISTS `trajetcolis` (
  `idTrajetColis` int(11) NOT NULL AUTO_INCREMENT,
  `Depart` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `Arivee` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `datelimit` date DEFAULT NULL,
  `currentDate` date DEFAULT NULL,
  `Colis_idColis` int(11) NOT NULL,
  PRIMARY KEY (`idTrajetColis`)
) ENGINE=MyISAM AUTO_INCREMENT=67 DEFAULT CHARSET=latin1;

--
-- Déchargement des données de la table `trajetcolis`
--

INSERT INTO `trajetcolis` (`idTrajetColis`, `Depart`, `Arivee`, `datelimit`, `currentDate`, `Colis_idColis`) VALUES
(66, 'Alger Centre, AlgÃ©rie', 'Oran, AlgÃ©rie', '2019-08-23', '2019-07-16', 44),
(65, 'Alger Centre, AlgÃ©rie', 'Annaba, AlgÃ©rie', '2019-08-31', '2019-07-16', 43),
(63, 'Alger Centre, AlgÃ©rie', 'Oran, AlgÃ©rie', '2019-07-26', '2019-07-16', 41),
(64, 'Alger Centre, AlgÃ©rie', 'Oran, AlgÃ©rie', '2019-07-27', '2019-07-16', 42),
(62, 'Alger, AlgÃ©rie', 'Merouana, AlgÃ©rie', '2019-07-19', '2019-07-08', 40);

-- --------------------------------------------------------

--
-- Structure de la table `trajettransporteur`
--

DROP TABLE IF EXISTS `trajettransporteur`;
CREATE TABLE IF NOT EXISTS `trajettransporteur` (
  `idTrajetTransporteur` int(11) NOT NULL AUTO_INCREMENT,
  `Depart` varchar(255) DEFAULT NULL,
  `Arivee` varchar(255) DEFAULT NULL,
  `DepDateDebut` date DEFAULT NULL,
  `DepDateFin` date DEFAULT NULL,
  `ArvDateDebut` date DEFAULT NULL,
  `ArvDateFin` date DEFAULT NULL,
  `Transporteur_idTransporteur` int(11) DEFAULT NULL,
  `valid` bit(1) DEFAULT NULL,
  PRIMARY KEY (`idTrajetTransporteur`),
  UNIQUE KEY `idTrajetTransporteur_UNIQUE` (`idTrajetTransporteur`),
  KEY `fk_TrajetTransporteur_Transporteur1_idx` (`Transporteur_idTransporteur`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8;

--
-- Déchargement des données de la table `trajettransporteur`
--

INSERT INTO `trajettransporteur` (`idTrajetTransporteur`, `Depart`, `Arivee`, `DepDateDebut`, `DepDateFin`, `ArvDateDebut`, `ArvDateFin`, `Transporteur_idTransporteur`, `valid`) VALUES
(7, 'Batna, AlgÃ©rie', 'Adrar, AlgÃ©rie', '2019-07-23', '2019-07-19', '2019-07-25', '2019-07-19', 12, b'1');
...
CREATE TABLE IF NOT EXISTS `transporteur` (
  ...
  `MoyenDeTrans` varchar(255) DEFAULT NULL,
  `Deviation` int(11) DEFAULT NULL,
  `FrequenceVoyage` varchar(255) DEFAULT NULL,
  `Arrets` varchar(255) DEFAULT NULL,
  `FormatColis` varchar(255) DEFAULT NULL,
  `PoidsColis` varchar(255) DEFAULT NULL,
  `dateDepot` date DEFAULT NULL,
  `Rating` double DEFAULT NULL,
  `User_idUser` int(11) DEFAULT NULL,
  PRIMARY KEY (`idTransporteur`),
  UNIQUE KEY `idTransporteur_UNIQUE` (`idTransporteur`),
  KEY `fk_Transporteur_User1_idx` (`User_idUser`)
...
INSERT INTO `transporteur` (`idTransporteur`, `MoyenDeTrans`, `Deviation`, `FrequenceVoyage`, `Arrets`, `FormatColis`, `PoidsColis`, `dateDepot`, `Rating`, `User_idUser`) VALUES
(11, 'Voiture', 4, 'Occasionnel', 'setif', 'S', 'LÃ©ger', '2019-07-05', NULL, 62),
(12, 'Camion', 6, 'Occasionnel', 'biskra', 'M', 'Lourd', '2019-07-05', NULL, 62),
(17, 'Voiture', 5, 'Occasionnel', 'ggg_hhh', 'XS', 'T.LÃ©ger', '2019-07-05', 0, 63),
(18, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2.6666666666667, 64);
...
CREATE TABLE IF NOT EXISTS `unite` (
  ...
  `uniteDist` int(11) DEFAULT NULL,
  `unitePoid` int(11) DEFAULT NULL,
  `uniteTaille` int(11) DEFAULT NULL,
  `uniteTemps` int(11) DEFAULT NULL,
  `pDistance` double DEFAULT NULL,
  `pPoid` double DEFAULT NULL,
  `pTaille` double DEFAULT NULL,
  `pTemps` double DEFAULT NULL,
  PRIMARY KEY (`idUnite`)
...
INSERT INTO `unite` (`idUnite`, `uniteDist`, `unitePoid`, `uniteTaille`, `uniteTemps`, `pDistance`, `pPoid`, `pTaille`, `pTemps`) VALUES
(1, 2, 100, 10, 10, 0.5, 0.1, 0.3, 0.1);
...
CREATE TABLE IF NOT EXISTS `utilisateur` (
  ...
  `Declaration_honneur` varchar(255) DEFAULT NULL,
  `PieceIdentite` varchar(255) DEFAULT NULL,
  `Valid` bit(1) DEFAULT NULL,
  `Sexe` varchar(255) DEFAULT NULL,
  `Detes` float DEFAULT NULL,
...
INSERT INTO `utilisateur` (`idUser`, `Nom`, `Prenom`, `Email`, `Numero_Telephone`, `Password`, `PhotoProfil`, `Contrat`, `UserType`, `Declaration_honneur`, `PieceIdentite`, `Valid`, `Sexe`, `Detes`, `Nom_utilisateur`, `Description`, `Vehicule`, `DateInscription`, `Experience`, `date_der_connexion`) VALUES
(62, 'anis', 'chebah', 'anis.chebah2016@gmail.com', '0652142145', '7dc5b254d58e5377dd23fb88306df0b662f2e549', NULL, NULL, NULL, NULL, NULL, b'1', 'Female', NULL, 'anis200', NULL, NULL, NULL, NULL, NULL),
(63, 'anis', 'sdksjd', 'ha@chebah.2016', '0666132812', '7dc5b254d58e5377dd23fb88306df0b662f2e549', NULL, NULL, NULL, NULL, NULL, b'1', 'Female', NULL, 'dsds', NULL, NULL, NULL, NULL, NULL),
(64, 'siahmed', 'massinissa', 'maci.16899@gmail.com', '0674073925', '2631e42d860bfc080e492a50b53a5487f04b5281', NULL, NULL, NULL, NULL, NULL, b'1', 'Male', 156.08, 'massino', NULL, NULL, '2018-01-02 00:00:00', 'DÃ©butant', '2019-07-16 06:41:12'),
(65, 'nom', 'prenom', 'mailmail@gmail.fr', '+21356899157', '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', NULL, NULL, NULL, NULL, NULL, b'1', 'Female', NULL, 'prenom1', NULL, 'automobile Audi R8', NULL, 'DÃ©butant', '2019-07-15 16:38:34');
...
--
-- Contraintes pour la table `avis_rating_envo`
--
ALTER TABLE `avis_rating_envo`
  ADD CONSTRAINT `avis_rating_envo_ibfk_1` FOREIGN KEY (`idEnvoyeur`) REFERENCES `envoyeur` (`idEnvoyeur`),
  ADD CONSTRAINT `avis_rating_envo_ibfk_2` FOREIGN KEY (`idTransporteur`) REFERENCES `transporteur` (`idTransporteur`);

--
-- Contraintes pour la table `avis_rating_trans`
--
ALTER TABLE `avis_rating_trans`
  ADD CONSTRAINT `avis_rating_trans_ibfk_1` FOREIGN KEY (`idEnvoyeur`) REFERENCES `envoyeur` (`idEnvoyeur`),
  ADD CONSTRAINT `avis_rating_trans_ibfk_2` FOREIGN KEY (`idTransporteur`) REFERENCES `transporteur` (`idTransporteur`);

--
-- Contraintes pour la table `colis`
--
ALTER TABLE `colis`
  ADD CONSTRAINT `fk_Colis_Envoyeur1` FOREIGN KEY (`Envoyeur_idEnvoyeur`) REFERENCES `envoyeur` (`idEnvoyeur`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
-- Contraintes pour la table `envoyeur`
--
ALTER TABLE `envoyeur`
  ADD CONSTRAINT `fk_Envoyeur_User1` FOREIGN KEY (`User_idUser`) REFERENCES `utilisateur` (`idUser`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Contraintes pour la table `invitations`
--
ALTER TABLE `invitations`
  ADD CONSTRAINT `fk_Invitations_User1` FOREIGN KEY (`User_idUser`) REFERENCES `utilisateur` (`idUser`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Contraintes pour la table `messages`
--
ALTER TABLE `messages`
  ADD CONSTRAINT `messages_ibfk_1` FOREIGN KEY (`idEnvoyeur`) REFERENCES `utilisateur` (`idUser`),
  ADD CONSTRAINT `messages_ibfk_2` FOREIGN KEY (`idRecepteur`) REFERENCES `utilisateur` (`idUser`);

--
-- Contraintes pour la table `transporteur`
--
ALTER TABLE `transporteur`
  ADD CONSTRAINT `fk_Transporteur_User1` FOREIGN KEY (`User_idUser`) REFERENCES `utilisateur` (`idUser`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
